...
def chatbot_route(spell, model, words, stemmer, labels, data, unidentified_questions):
    ...
    response = chat(spell, model, words, stemmer, labels, data, user_question, context_state_user, unidentified_questions)
    return response
